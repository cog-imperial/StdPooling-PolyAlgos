...
options optcr=1.e-9, optca=1.e-6, limrow=0, limcol=0, reslim=3600, solveopt=clear;
#===============================================================================
# Declare sets
#===============================================================================
set l(i);
...
profit.lo = -pqmodel.objest;
profit.up = -pqmodel.objval;
scalar genTime;
scalar solveTime;
scalar nodesUsed;
genTime = pqmodel.resgen;
solveTime = pqmodel.resusd;
nodesUsed = pqmodel.nodUsd;
option clear=a,clear=bl,clear=bu,clear=c,clear=q,clear=qualub,clear=rlt1,clear=x,clear=y,clear=pathdef,clear=f;
#option clear=a,clear=bl,clear=bu,clear=c,clear=f,clear=i;
#clear=q,clear=qualub,clear=rlt1,clear=s,clear=t,clear=x,clear=y;
#file line;
